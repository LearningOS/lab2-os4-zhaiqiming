...
impl TaskManager {
    ...
    fn mmap(&self, start: usize, len: usize, port: usize) -> isize {
        ...
        let page_table = PageTable::from_token(inner.tasks[current_task_number].get_user_token());
        ...
        // println!("Start");
        inner.tasks[current_task_number].memory_set.insert_framed_area(VirtAddr::from(start), VirtAddr::from(start + len), permission);
        // println!("End");
        0
    }
    ...
    fn munmap(&self, start: usize, len: usize) -> isize {
        ...
        for vpn in VPNRange::new(start_vpn, end_vpn) {
            inner.tasks[current_task_number].memory_set.munmap(vpn);
        }
        0
    }
}
